...
opts_q7 <- c(
  "It tells you nothing about effect size, because effect size and sample size both contribute to the p-value; a tiny effect with a huge sample can also produce a very small p-value.",
